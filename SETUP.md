...
פק"ע שאין לה שורות בגיליון נשארת בלי סידוריים — ובלעדיהם אי אפשר לדווח עליה
עבודה. אפשר לסמן ״השלם סידוריים לפק"ע שאינן בגיליון״ כדי לייצר להן סידוריים
זמניים לפי הכמות; אלה **לא** מגיעים מ-Priority, ויוחלפו בייבוא הבא שכן יכיל אותן.
